...
***********************************************************************************************************************/
/*LDRA_INSPECTED 93 S Value is appropriate type */
...
static const bsp_feature_cgc_t g_cgc_feature =
{
    ...
    .pllccr_type            = (uint8_t)(1U),
    .iclk_div               = (uint8_t)(BSP_CFG_ICK_DIV),
    .has_lcd_clock          = 0U,
    .has_sdram_clock        = 0U,
...
{
    p_ctsu_feature->ctsucr0_mask = 0x97U;
    p_ctsu_feature->ctsucr1_mask = 0xFBU;
    p_ctsu_feature->ctsumch0_mask = 0x1FU;
    p_ctsu_feature->ctsumch1_mask = 0x1FU;
    p_ctsu_feature->ctsuchac_register_count = 2U;
    p_ctsu_feature->ctsuchtrc_register_count = 2U;
}
...
void R_BSP_FeatureSdhiGet(bsp_feature_sdhi_t * p_sdhi_feature)
{
    ...
    p_sdhi_feature->supports_8_bit_mmc = 0U;
