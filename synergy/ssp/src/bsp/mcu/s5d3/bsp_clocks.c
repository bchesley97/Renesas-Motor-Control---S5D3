...
/*******************************************************************************************************************//**
 * @brief      This function sets the RAM wait state settings for both the SRAM0 and SRAM0(ECC) RAM memory
 * @param[in]  The number of wait states to be used.
 * @retval     none
 **********************************************************************************************************************/
...
/** @} (end defgroup BSP_MCU_CLOCKS) *//** @} (end defgroup BSP_MCU_CLOCKS) */
